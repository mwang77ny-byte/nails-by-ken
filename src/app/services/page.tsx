...
const sections = [
  {
    ...
    items: [
      { name: "Spa Manicure",              price: "$20"  },
      { name: "Spa Pedicure",              price: "$33"  },
      { name: "Manicure with Gel",         price: "$37"  },
      { name: "Pedicure with Gel",         price: "$45"  },
      { name: "Deluxe Pedicure",           price: "$48"  },
      { name: "Deluxe Pedicure with Gel",  price: "$60"  },
    ],
  },
  {
